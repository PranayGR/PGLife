<?php
    ...
    if(!$city){
        echo "Sorry ! We don't have any PG listed in this city.";
        return; 
    }
    ...
    $sql_3 = "SELECT *
             ...
             INNER JOIN properties p ON iup.properties_id = p.id
                ...
                <div class="row no-gutters justify-content-between">
                    ...
                    <?php
                        ...
                        foreach($interested_users_properties as $interested_user_property){
                            if($interested_user_property['properties_id'] == $property['id']){
                                $interested_user_count++;
                                if($interested_user_property['users_id'] == $user_id){
                                    $is_interested = true;
                                }
                            } 
                        }
