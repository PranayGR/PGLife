<?php
    ...
    $sql_1 = "SELECT *, p.id AS property_id, p.name AS property_name
              FROM properties p
    ...
    $sql_3 = "SELECT a.*
              FROM amenities a
              INNER JOIN properties_amenities pa ON a.id = pa.amenities_id
              WHERE pa.properties_id = $property_id";
    ...
    $sql_4 = "SELECT * FROM interested_users_properties WHERE properties_id = $property_id";
...
<head>
    ...
    <title><?= $property['property_name']?> | PGLife</title>
...
<body>
    ...
    <div class="property-summary page-container">
        <div class="row no-gutters justify-content-between">
            <?php
            $total_rating = ($property['clean_rating'] + $property['food_rating'] + $property['safety_rating']) / 3;
            ...
            <div class="interested-container col-6">
                <?php 
                $is_interested = false;
                foreach ($interested_users as $interested_user){
                    if ($interested_user['users_id'] == $user_id){
                        $is_interested = true;
                    }
                }
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    <div class="rating-criteria row">
                        ...
                        <div class="rating-criteria-star-container col-6" title="<?= $property['clean_rating']?>">
                        <?php
                        $rating = $property['clean_rating'];
                        for($i=0; $i<5; $i++){
                            if($rating >= $i + 0.8){
                        ?>
                                <i class="fas fa-star"></i>
                    ...
                    <div class="rating-criteria row">
                        ...
                        <div class="rating-criteria-star-container col-6" title="<?= $property['food_rating']?>">
                        <?php
                    ...
                    <div class="rating-criteria row">
                        ...
                        <div class="rating-criteria-star-container col-6" title="<?= $property['safety_rating']?>">
                        <?php
                        $rating = $property['safety_rating'];
                        for($i=0; $i<5; $i++){
                            if($rating >= $i + 0.8){
                        ?>
                                <i class="fas fa-star"></i>
