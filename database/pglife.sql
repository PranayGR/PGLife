...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2021 at 12:00 PM
...
INSERT INTO `interested_users_properties` (`id`, `users_id`, `properties_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 5),
(4, 2, 1),
...
CREATE TABLE `properties` (
  ...
  `clean_rating` float(2,1) NOT NULL,
  `food_rating` float(2,1) NOT NULL,
  `safety_rating` float(2,1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `properties` (`id`, `city_id`, `name`, `address`, `description`, `gender`, `rent`, `clean_rating`, `food_rating`, `safety_rating`) VALUES
...
INSERT INTO `properties_amenities` (`id`, `properties_id`, `amenities_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 4),
(4, 1, 5),
...
(6, 'allforgames215@gmail.com', '8778efca69c36fa869a40f43c20f895946bf279b', 'Pranay Rapartiwar', '7397957072', 'male', 'Sipna COET'),
(7, 'pranayrapartiwar@gmail.com', '8778efca69c36fa869a40f43c20f895946bf279b', 'Gaurishankar', 'xxxxxxxxxx', 'male', 'Sipna COET'),
(8, 'kapsesomu5@gmail.com', 'a6739e4f059e4ff342724753c54070d046b40eb5', 'Snehashish', 'xxxxxxxxxx', 'male', 'Sipna COET'),
(9, 'assa@gmail.com', 'c7d02915aa519f5d75fcf53f90ae71d82f7dd963', 'adad', '0739795707', 'male', 'Sipna COET'),
(10, 'aawdad@gmail.com', '27d47df80e113c86685112717f379e3e9e4c4629', 'Pranay Rapartiwar', '0739795707', 'male', 'Sipna COET');
...
--
ALTER TABLE `interested_users_properties`
  ADD CONSTRAINT `interested_users_properties_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `interested_users_properties_ibfk_2` FOREIGN KEY (`properties_id`) REFERENCES `properties` (`id`);
...
--
ALTER TABLE `properties_amenities`
  ADD CONSTRAINT `properties_amenities_ibfk_1` FOREIGN KEY (`properties_id`) REFERENCES `properties` (`id`),
  ADD CONSTRAINT `properties_amenities_ibfk_2` FOREIGN KEY (`amenities_id`) REFERENCES `amenities` (`id`);
